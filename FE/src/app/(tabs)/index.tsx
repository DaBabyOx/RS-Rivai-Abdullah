    ...
    <View style={styles.container}>
      ...
      <View style={styles.topBox}>
        ...
        <View style={styles.HaDafDar}>
          ...
          <TouchableOpacity style={styles.emergency}>
            <MaterialCommunityIcons name="alarm-light-outline" size={15} color="white" />
        ...
        <View style={styles.barContainer}>
          {!barClicked && <FontAwesome6 name="magnifying-glass" size={20} color="black" />}
          <TextInput
        ...
        <View style={styles.leBar}>
          <View style={styles.bagianKiriKunjungan}>
            ...
            <View style={styles.textKiri}>
              <Text style={{ fontSize: fonts.large, fontWeight: 'bold', color: 'white' }}>Buat Kunjungan</Text>
              <Text style={{ fontSize: fonts.small, color: 'white', fontWeight: 'medium' }}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.containerBerita}>
          <Text style={[styles.textBerita, themeText]}>Berita & Penawaran Khusus</Text>
          <FlatList
            ref={flatListRef}
            data={gambarBanner}
            horizontal
        ...
        <View style={styles.alurContainer}>
          <View>
            <Image source={require('@/assets/blue/Kiri.png')} style={styles.iconsKiri} />
          </View>
          <View>
            <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 19, color: '#00BE61' }}>ALUR SISTEM</Text>
            <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 19, color: 'white' }}>PENDAFTARAN</Text>
            <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 19, color: 'black' }}>ONLINE</Text>
            <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 19, color: '#DC4031' }}>RAWAT JALAN</Text>
          </View>
          <View>
            <Image source={require('@/assets/blue/Kanan.png')} style={styles.iconsKanan} />
          </View>
        </View>
