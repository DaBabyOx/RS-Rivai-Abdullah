  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={styles.buttonStyle} onPress={() => router.push("/ui/kunjungan/buat-kunjungan/page")}>
          <Text style={styles.buttonText}>Buat Kunjungan</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.buttonStyle} onPress={() => router.push("/ui/rencana/validasi-bukti-pendaftaran/page")}>
