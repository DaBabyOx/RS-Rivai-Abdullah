  ...
  const handleGetAccount = () => {
    ...
    if (validatePhoneNumber(phoneNumber)) {
      ...
      setTimeout(() => {
        ...
        router.push(
          `/ui/profile/auth/phone-auth/phone-otp/page?phoneNumber=${phoneNumber}`
        );
      }, 1500);
    } else {
      ...
      <View style={stylesImport.contentContainer}>
        ...
        <View style={stylesImport.loginHeaderContainer}>
          <Text style={stylesImport.loginDescStyle}>
            Silahkan masukan No.HP yang terdaftar untuk mengirimkan data akun
            anda via WhatsApp.
          </Text>
          <Text
            style={{
        ...
        <View style={stylesImport.buttonContainer}>
          <View style={stylesImport.loginButton}>
            <TouchableOpacity
              onPress={() =>
                router.push("/ui/profile/auth/phone-auth/phone-preotp/page")
              }
            >
