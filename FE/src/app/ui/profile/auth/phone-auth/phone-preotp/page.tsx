      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.loginHeaderContainer}>
          <Text style={styles.loginDescStyle}>
            Silahkan masukan No. HP yang terdaftar untuk mengirimkan OTP via WhatsApp.
          </Text>
        ...
        <View style={styles.buttonContainer}>
          <View style={styles.loginButton}>
            <TouchableOpacity onPress={() => router.push('/ui/profile/auth/phone-auth/phone-preotp/phone-otp/page')}>
